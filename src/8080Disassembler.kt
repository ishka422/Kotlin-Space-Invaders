...
fun main() {
    ...
    while (i < bytes.size) {
        ...
        when (st) {
            ...
            "01" -> {
                println(String.format("01  LXI, B: %02X %02X", bytes[i+2], bytes[i+1]))
                i += 3
            }
            "02" -> {
            ...
            "06" -> {
                println(String.format("06  MVI B <- %02X", bytes[i+1]))
                i+=2
            ...
            "0E" -> {
                println(String.format("0e MVI      C  <-  %02X", bytes[i+1]))
                i +=2
            ...
            "11" -> {
                println(String.format("11 LXI  D <-  %02X  E <-  %02X", bytes[i+2], bytes[i+1]))
                i+=3
            }
            "12" -> {
            ...
            "16" -> {
                println(String.format("16  MVI  D  <- %02X", bytes[i+1]))
                i+=2
            ...
            "1E" -> {
                println(String.format("1e MVI  E  <- %02X", bytes[i+1]))
                i+=2
            ...
            "21" -> {
                println(String.format("21 LXI    H  <-  %02X L  <-  %02X", bytes[i+2], bytes[i+1]))
                i += 3
            }
            "22" -> {
                println(String.format("22 DHLD     (adr)  <-  L, (adr)  <-  H", bytes[i+1], bytes [i+2]))
                i += 3
            ...
            "26" -> {
                println(String.format("26 MVI      H  <-  %02X", bytes[i+1]))
                i +=2
            ...
            "2E" -> {
                println(String.format("2e MVI     L  <-  %02X", bytes[i+1]))
                i +=2
            ...
            "31" -> {
                println(String.format("31 LXI      SP.hi  <- %02X  SP.lo  <- %02X", bytes[i+2], bytes[i+1]))
                i+=3
            }
            "32" -> {
                println(String.format("32 STA    a16, %02X %02X", bytes[i+1], bytes [i+2]))
                i += 3
            ...
            "36" -> {
                println(String.format("36 MVI      M  <-  %02X", bytes[i+1]))
                i +=2
            ...
            "C2" -> {
                println(String.format("JNZ %02X %02X", bytes[i+2], bytes[i+1]))
                i+=3

            }
            "C3" -> {
                println(String.format("JMP  %02X %02X", bytes[i+2], bytes[i+1]))
                i += 3
            }
            "C4" -> {
                println(String.format("CNZ  %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "C6" -> {
                println(String.format("ADI %02X", bytes[i+1]))
                i +=2
            ...
            "CA" -> {
                println(String.format("JZ  %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "CC" -> {
                println(String.format("CZ %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3

            }
            "CD" -> {
                println(String.format("CALL     a16, %02X %02X", bytes[i+2], bytes[i+1]))
                i += 3

            }
            "CE" -> {
                println(String.format("ACI %02X", bytes[i+1]))
                i+=2
            ...
            "D2" -> {
                println(String.format("JNC %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "D4" -> {
                println(String.format("CNC %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "D6" -> {
                println(String.format("SUI %02X", bytes[i+1]))
                i +=2
            ...
            "DA" -> {
                println(String.format("JC     a16, %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "DC" -> {
                println(String.format("CC %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "DE" -> {
                println(String.format("SBI %02X", bytes[i+1]))
                i+=2
            ...
            "E2" -> {
                println(String.format("JPO %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "E4" -> {
                println(String.format("CPO %02X %02X", bytes[i+2], bytes[i+1]))
                i+=3
            ...
            "E6" -> {
                println(String.format("ANI %02X", bytes[i+1]))
                i +=2
            ...
            "EA" -> {
                println(String.format("JPE %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "EC" -> {
                println(String.format("CPE %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "EE" -> {
                println(String.format("XRI %02X", bytes[i+1]))
                i +=2
            ...
            "F2" -> {
                println(String.format("JP %02X %02X", bytes[i+2], bytes[i+1]))
                i+=3
            ...
            "F4" -> {
                println(String.format("CP %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "F6" -> {
                println(String.format("ORI %02X", bytes[i+1]))
                i +=2
            ...
            "FA" -> {
                println(String.format("JM %02X %02X", bytes[i+2], bytes[i+1]))
                i +=3
            ...
            "FC" -> {
                println(String.format("CM %02X %02X", bytes[i+2], bytes[i+1]))
                i+=3
            ...
            "FE" -> {
                println(String.format("CPI %02X", bytes[i+1]))
                i +=2
